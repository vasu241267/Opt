...
DEVELOPER_ID = os.getenv("DEVELOPER_ID", "@YourDeveloperID")  # Replace with your Telegram ID
CHANNEL_LINK = os.getenv("CHANNEL_LINK", "@YourChannel")  # Replace with your Telegram channel ID
